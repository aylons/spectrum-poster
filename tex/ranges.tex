...
{\yellow
 ...
 %from http://www.dxing.com/tuning.htm 4000 to 4063 kHz:  mainly used by military forces
  ...
  \psframe[framearc=0.25](0.99,16.0)(1.76,16.2)\rput(1.38,16.1){\textcolor{Black}{Remote Ctrl}}

}

  % CB Radio 26.960-27.260 MHz
  \definecolor{BoxColor}{rgb}{0.6,0.68,0.86}
  \psframe[fillstyle=solid, fillcolor=BoxColor,linewidth=0pt,linestyle=none](6.71,15.15)(6.86,15.35)
...
%  \rput(2.34,16.10){DTV}
  ...
  \psframe[fillstyle=solid, fillcolor=BoxColor,linewidth=0pt,linestyle=none](2.66,16.7)(3.67,16.8)
  %\rput(2.66,16.70){162MHz}
  \rput(3.17,16.75){Marine Mobile}
...
%  \rput(8,16.60){SuperBand - CATV ch 23-36}
  ...
  \definecolor{BoxColor}{rgb}{0.6,0.68,0.86}
  \psframe[fillstyle=solid, fillcolor=BoxColor,linewidth=0pt,linestyle=none](7.30,16.7)(9.80,16.8)\wrapuparrow{BoxColor}{16.75}
  \psframe[fillstyle=solid, fillcolor=BoxColor,linewidth=0pt,linestyle=none](0.00,17.2)(5.64,17.3)\wrapdnarrow{BoxColor}{17.25}
  \rput(8.55,16.75){Military}
...
%from http://www.dxing.com/above30.htm 406 to 420 MHz: In the United States, this band is used exclusively by the federal government. All transmissions are in FM, with most channels spaced at 25 kHz intervals.
  ...
  \psframe[fillstyle=solid, fillcolor=BoxColor,linewidth=0pt,linestyle=none](5.64,17.2)(6.33,17.3) \rput(5.98,17.25){Gov}
...
%  \rput(4.16,17.10){HyperBand-CATV Ch 37-62}
  ...
  \rput(3,18.14){\psframebox[fillstyle=solid,fillcolor=Fill,framesep=2pt]{\textcolor{white}{Microwave L-band (Long)}}}
  ...
  \rput(0.29,16.75){\weatherstation}%137MHz
...
\tiny
  ...
  \rput(7.77,18.55){\psframebox{01}}	%3720
  ...
  \rput(3.5,19.65){\psframebox[fillstyle=solid,fillcolor=Fill,framesep=2pt]{\textcolor{white}{Microwave X-band (X marks the spot)}}}
  ...
  \rput(8,19.65){\psframebox[fillstyle=solid,fillcolor=Fill,framesep=2pt]{\textcolor{white}{Microwave Ku-band (Kurtz Under)}}}
  ...
  \rput(2,20.15){\psframebox[fillstyle=solid,fillcolor=Fill,framesep=2pt]{\textcolor{white}{Microwave K-band (Kurtz)}}}
...
\psline[linecolor=white,linestyle=solid,linewidth=1pt]{<->}(-.1,0)(.1,0)
  ...
  \rput{90}(\EMRPositionD,22.89){\psframebox[fillcolor=DarkRange]{\footnotesize\textcolor{RangesText}{Microwave \micro mm-band}}}
